unit XFG_default_view_docbench;
...
type
  ...
  TXFG_default_view_docbench = class(TRedStone_Public_Comp)
    procedure DoClose;
 ...
 //       procedure PCMBClick(Sender: TObject);
   ...
   PASSxfgmemo:tmemo;
    ...
    cmb1,cmb2,cmb3,cmb4,cmb5,cmb6,cmb7:tcombobox;
  lb1,lb2,lb3,lb4,lb5,lb6,lb7:tlabel;
...
constructor TXFG_default_view_docbench.Create(APass_Handle:QApplicationH;APass_Form:Tform;const APassCallingCaptionHint,APass_ExeName:string;
...
*************************************************************************)
    ...
    F.caption:='XFG_default_view_docbench';
   // F.Show;
    F.ShowModal;
    /////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
 ...
 procedure TXFG_default_view_docbench.SpClick(Sender: TObject);
 ...
 begin
  ...
  begin
    ...
    ini.WriteString('xfgFileTypeExecution','%'+(temp as Tlabel).caption+'%',(cm as tcombobox).Text+' $in &');
    end; 
    end;
 ini.updatefile;
 restartxfg:=true;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
  procedure TXFG_default_view_docbench.DoClose;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 procedure TXFG_default_view_docbench.DoClose2(Sender: TObject; var Action: TCloseAction);
...
procedure TXFG_default_view_docbench.createpagecontrol; 
begin
...
procedure TXFG_default_view_docbench.createts1; 
var 
cmbS,labelS:integer;
 ...
 begin
  ...
  lb1:=tlabel.create(nil);
   ...
   name:='lb1';
            ...
            AutoSize := false;
            Caption := 'text';
             cmb1.text:=stringreplace(ini.ReadString('xfgFileTypeExecution','%'+Caption+'%','none'),' $in &','',[rfreplaceall,rfIgnoreCase]);
            Layout := tlCenter;
          end;
  ...
  lb2:=tlabel.create(nil);
   ...
   name:='lb2';
            ...
            AutoSize := false;
            Caption := 'html';
            cmb2.text:=stringreplace(ini.ReadString('xfgFileTypeExecution','%'+Caption+'%','none'),' $in &','',[rfreplaceall,rfIgnoreCase]);
            Layout := tlCenter;
          end;
  lb3:=tlabel.create(nil);
   ...
   name:='lb3';
            ...
            AutoSize := false;
            Caption := 'image';
            cmb3.text:=stringreplace(ini.ReadString('xfgFileTypeExecution','%'+Caption+'%','none'),' $in &','',[rfreplaceall,rfIgnoreCase]);
            Layout := tlCenter;
          end;
  lb4:=tlabel.create(nil);
   ...
   name:='lb4';
            ...
            AutoSize := false;
            Caption := 'postscript';
            cmb4.text:=stringreplace(ini.ReadString('xfgFileTypeExecution','%'+Caption+'%','none'),' $in &','',[rfreplaceall,rfIgnoreCase]);
            Layout := tlCenter;
          end;       
  ...
  lb5:=tlabel.create(nil);
   ...
   name:='lb5';
            ...
            AutoSize := false;
            Caption := 'adobe';
            cmb5.text:=stringreplace(ini.ReadString('xfgFileTypeExecution','%'+Caption+'%','none'),' $in &','',[rfreplaceall,rfIgnoreCase]);
            Layout := tlCenter;
          end;    
  ...
  lb6:=tlabel.create(nil);
   ...
   name:='lb6';
            ...
            AutoSize := false;
            Caption := 'dvi';
            cmb6.text:=stringreplace(ini.ReadString('xfgFileTypeExecution','%'+Caption+'%','none'),' $in &','',[rfreplaceall,rfIgnoreCase]);
  ...
  lb7:=tlabel.create(nil);
   ...
   name:='lb7';
            ...
            AutoSize := false;
            Caption := 'file';
            cmb7.text:=stringreplace(ini.ReadString('xfgFileTypeExecution','%'+Caption+'%','none'),' $in &','',[rfreplaceall,rfIgnoreCase]);
...
procedure TXFG_default_view_docbench.createts2; 
begin
...
procedure TXFG_default_view_docbench.createts3; 
begin
...
procedure TXFG_default_view_docbench.creatememo;
begin
...
procedure TXFG_default_view_docbench.createspeedbutton;
...
procedure TXFG_default_view_docbench.createpanel1;
begin
...
procedure TXFG_default_view_docbench.createpanel2;
begin
...
procedure TXFG_default_view_docbench.createsplitter;
begin
...
destructor TXFG_default_view_docbench.Destroy;
...
initialization
registerclass(TXFG_default_view_docbench);
finalization

unregisterclass(TXFG_default_view_docbench);
end.
