...
/////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 //       procedure PCMBClick(Sender: TObject);
  ...
  UserCallingDIR,UserCallingIniconf,UserCallingImageDIR,UserCallingDataDIR,UserCallingVersion:string;
...
*************************************************************************)
    ...
    F.caption:='Redstone_sendtoprinter';
   // F.Show;
    F.ShowModal;
...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
procedure TRedstone_sendtoprinter.checkout2(Sender: TObject);
begin
...
//////////////////////////////////////////////////////////////////////////////////
 ...
 procedure TRedstone_sendtoprinter.SpClick(Sender: TObject);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
  procedure TRedstone_sendtoprinter.DoClose;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 procedure TRedstone_sendtoprinter.DoClose2(Sender: TObject; var Action: TCloseAction);
...
procedure TRedstone_sendtoprinter.createpagecontrol; 
begin
...
procedure TRedstone_sendtoprinter.createts1; 
...
procedure TRedstone_sendtoprinter.createts2; 
begin
...
procedure TRedstone_sendtoprinter.createts3; 
begin
...
procedure TRedstone_sendtoprinter.creatememo;
begin
...
procedure TRedstone_sendtoprinter.createspeedbutton;
...
speedbutton.parent:=p1;
 ...
 speedbutton.font.color:=clwhite;
  speedbutton.font.name:='sans';
    ...
    ss:= l1.Strings[mi];
       ...
       begin  ss:='Get printers';sbStartSearch:=speedbutton;end;
     
     if lowercase(l1.Strings[mi])='apply settings' then 
     begin
     ss:='Send to printer';
     sbStopSearch:=speedbutton;
         if fileexists(UserCallingImageDIR+'print.png')=true then
     SpeedButton.Glyph.LoadFromFile(UserCallingImageDIR+'print.png');
 end else begin
 ...
 speedbutton.Hint :=ss;
      ...
      speedbutton.Layout := blGlyphTOP;      speedbutton.ParentShowHint := False;
...
procedure TRedstone_sendtoprinter.createpanel1;
begin
...
procedure TRedstone_sendtoprinter.createpanel2;
begin
...
procedure TRedstone_sendtoprinter.createsplitter;
begin
