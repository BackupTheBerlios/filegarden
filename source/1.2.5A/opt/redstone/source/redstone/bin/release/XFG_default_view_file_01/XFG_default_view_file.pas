...
type
  ...
  TXFG_default_view_file = class(TRedStone_Public_Comp)
    procedure DoClose;
...
constructor TXFG_default_view_file.Create(APass_Handle:QApplicationH;APass_Form:Tform;const APassCallingCaptionHint,APass_ExeName:string;
...
*************************************************************************)
    ...
    F.caption:='XFG_default_view_file';
   // F.Show;
    F.ShowModal;
    /////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
 ...
 procedure TXFG_default_view_file.SpClick(Sender: TObject);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
  procedure TXFG_default_view_file.DoClose;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 procedure TXFG_default_view_file.DoClose2(Sender: TObject; var Action: TCloseAction);
...
procedure TXFG_default_view_file.createpagecontrol; 
begin
...
procedure TXFG_default_view_file.createts1; 
var 
cmbS,labelS:integer;
...
procedure TXFG_default_view_file.createts2; 
begin
...
procedure TXFG_default_view_file.createts3; 
begin
...
procedure TXFG_default_view_file.creatememo;
begin
...
procedure TXFG_default_view_file.createspeedbutton;
...
procedure TXFG_default_view_file.createpanel1;
begin
...
procedure TXFG_default_view_file.createpanel2;
begin
...
procedure TXFG_default_view_file.createsplitter;
begin
...
destructor TXFG_default_view_file.Destroy;
...
initialization
registerclass(TXFG_default_view_file);
finalization

unregisterclass(TXFG_default_view_file);
end.
